  ...
  return (
    <div className="w-full">
      ...
      <div className="w-full shadow-sm bg-gradient-to-r from-[#660033] via-[#4B0055] to-[#330066] h-20 flex items-center justify-between lg:pr-[30px] pr-4 md:pr-6 ">
        ...
        <div className="hidden lg:flex bg-gray-600 mx-3 lg:w-[350px] h-10 rounded-md bg-opacity-50">
...

          {
            user ? (
              <div className="relative group hidden lg:flex items-center mt-2 ml-2 cursor-pointer">
                ...
                {/* Dropdown on hover */}
                <div className="absolute top-[42px] right-0 w-[180px] bg-white text-black shadow-lg rounded-md hidden scale-95 group-hover:block group-hover:scale-100 transition-all duration-300 z-50">
                  <div className="px-4 py-2 border-b text-sm">Hello, {user?.name}</div>
